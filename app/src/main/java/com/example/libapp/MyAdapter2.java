...
public class MyAdapter2 extends RecyclerView.Adapter<MyViewHolder2> {
    ...
    public MyViewHolder2 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycle_view_borrow, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder2 holder, int position) {
        ...
        holder.recCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, StudentBorrowBook.class);
